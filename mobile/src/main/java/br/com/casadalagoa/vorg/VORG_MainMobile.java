 ...
 * the paired wearable.
 */
public class VORG_MainMobile extends Activity implements DataApi.DataListener,
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            FetchBoatTask fetchData = new FetchBoatTask(this.getBaseContext());
            fetchData.execute();
            return true;
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_vorg_main_mobile, menu);
        return true;
    }
    ...
    public void onCreate(Bundle b) {
        ...
        setContentView(R.layout.activity_vorg_main_mobile);
        setupViews();
